...
pub unsafe extern "C" fn _ZN4astc4randEPm(mut _5: *mut libc::c_void) -> uint64_t {
    ...
    _7 = _11;
    _12 = _6;
    _13 = *(&mut *(_12 as *mut uint64_t).offset(1 as libc::c_int as int64_t as isize)
        as *mut uint64_t);
    _8 = _13;
    _14 = _7;
    _15 = _8;
    ...
    _8 = _17 ^ _16;
    _18 = _7;
    _19 = _ZL4rotlmi(_18, 24 as libc::c_int as uint32_t);
    _20 = _8;
    _21 = _8;
    _22 = _6;
    *(_22 as *mut uint64_t) = _19 ^ _20 ^ _21 << 16 as libc::c_int;
    _23 = _8;
...
unsafe extern "C" fn _ZL4rotlmi(mut _27: uint64_t, mut _28: uint32_t) -> uint64_t {
    ...
    return _31 << _32 as uint64_t
        | llvm_lshr_u64(
            _33,
            llvm_sub_u32(64 as libc::c_int as uint32_t, _34) as uint64_t,
        );
}
