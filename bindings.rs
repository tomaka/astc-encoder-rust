...
pub unsafe fn astcenc_config_init(
    ...
    crate::src::astcenc_entry_cbe::_Z19astcenc_config_init15astcenc_profilejjjfjP14astcenc_config(
        profile,
        block_x,
        block_y,
        block_z,
...
pub unsafe fn astcenc_context_alloc(
    ...
    crate::src::astcenc_entry_cbe::_Z21astcenc_context_allocPK14astcenc_configjPP15astcenc_context(
        config.cast_mut().cast(),
        thread_count,
        context.cast(),
    )
}
...
pub unsafe fn astcenc_get_error_string(status: astcenc_error) -> *const ::core::ffi::c_char {
    crate::src::astcenc_entry_cbe::_Z24astcenc_get_error_string13astcenc_error(status)
        .cast_const()
        .cast()
}
